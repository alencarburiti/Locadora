...
INSERT INTO `ACESSO` VALUES (31,0,0,0,0,3,17);
...
INSERT INTO `TIPO_SERVICO` VALUES (1,'D','Locação: Valor Locação','L'),(2,'D','Devolução: Atraso na Devolução','D'),(3,'C','Locação: Desconto','L'),(4,'C','Dinheiro',NULL),(5,'D','Devolução: Débito de Devolução','D'),(6,'C','Locação: Pagamento Locação','L'),(7,'C','Devolução: Pagamento Devolução','D'),(8,'C','DEVOLUÇÃO: DESCONTO','D');
...
INSERT INTO `USUARIO` VALUES (3,'Administrador','admin','admin','0');
...
-- Dump completed on 2014-12-22 16:55:04
