...
public class ImpressaoComprovante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtbl_lancamento_caixa1 = new javax.swing.JTable();
        ...
        getContentPane().add(jb_sair, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 460, 90, -1));
        ...
        if (jtbl_lancamento_caixa.getColumnModel().getColumnCount() > 0) {
            ...
            jtbl_lancamento_caixa.getColumnModel().getColumn(1).setResizable(false);
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 380, 130));

        jScrollPane4.setName("jScrollPane4"); // NOI18N

        jtbl_lancamento_caixa1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jtbl_lancamento_caixa1.setName("jtbl_lancamento_caixa1"); // NOI18N
        jtbl_lancamento_caixa1.getTableHeader().setReorderingAllowed(false);
        jtbl_lancamento_caixa1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jtbl_lancamento_caixa1MouseClicked(evt);
            }
        });
        jScrollPane4.setViewportView(jtbl_lancamento_caixa1);
        if (jtbl_lancamento_caixa1.getColumnModel().getColumnCount() > 0) {
            jtbl_lancamento_caixa1.getColumnModel().getColumn(0).setPreferredWidth(50);
            jtbl_lancamento_caixa1.getColumnModel().getColumn(1).setResizable(false);
            jtbl_lancamento_caixa1.getColumnModel().getColumn(1).setPreferredWidth(80);
            jtbl_lancamento_caixa1.getColumnModel().getColumn(2).setPreferredWidth(50);
        }

        getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 320, 380, 130));
    ...
    private void jtbl_lancamento_caixa1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbl_lancamento_caixa1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_jtbl_lancamento_caixa1MouseClicked
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ImpressaoComprovante().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTable jtbl_lancamento_caixa1;
