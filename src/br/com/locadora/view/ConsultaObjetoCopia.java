 ...
 * @author ALENCAR
 */
public class ConsultaObjetoCopia extends javax.swing.JFrame {

    public AtendimentoLocacao janelapai;
    public List<Copia> copias;
    public Copia copia;

    public ConsultaObjetoCopia() {
        initComponents();
...
//                    janelapai.setStatusTela(true);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ConsultaObjetoCopia().setVisible(true);
            }
        });
    }
...
//                    data_prevista = "";
    ...
    public void buscarDados() {
        try {
            ...
            Logger.getLogger(ConsultaObjetoCopia.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
