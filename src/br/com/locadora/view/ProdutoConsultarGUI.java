...
//        mostraProduto(produtos,consulta);
    ...
    public void mostraProduto(List<Produto> produtos, String consulta) {
        ...
        if (produtos.size() == 0) {
            ...
            for (int i = 0; i < produtos.size(); i++) {
                ...
                row.addRow(new Object[]{produto.getCod_produto(), hashDbGrid, produto.getConcentraçao(), produto.getEstoque()});
            }
    ...
    public void mostra(List<Produto> produtos) {
        jb_novo1.setEnabled(false);
