...
public class ConsultaTipoObjeto extends javax.swing.JFrame {
    ...
    public void botaoOK(JTable tb) {
       if(tb.getSelectedRow() != -1){
        ...
        TipoObjeto forn = tbFornecedorLinhaSelecionada(jTable1);
...
//        if(jTable1.getSelectedRow()== 1){                           
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ConsultaTipoObjeto().setVisible(true);
            }
        });
    }
    ...
    public TipoObjeto tbFornecedorLinhaSelecionada(JTable tb) {
        TipoObjeto forn = null;
        if (tb.getSelectedRow() != -1) {
            forn = new TipoObjeto();
...
//        fornecedores = forn.listarForncedor("%" + consulta + "%");
    ...
    public void mostraFornecedor(List<TipoObjeto> fornecedores) {
        ...
        if (fornecedores.size() == 0) {
            ...
            for (int i = 0; i < fornecedores.size(); i++) {
                TipoObjeto fornecedor = new TipoObjeto();
