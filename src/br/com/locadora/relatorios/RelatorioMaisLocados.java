 ...
 * @author ALENCAR
 */
public class RelatorioMaisLocados {

    private InterfacePool pool;

    public RelatorioMaisLocados(InterfacePool pool) {
        this.pool = pool;
    }
    ...
    public void gerarRelatorio(String dataInicial, String dataFinal, String titulo) {
        ...
        try {
            ...
            if (totalRegistro > 0) {
                ...
                JasperPrint jasperPrint = JasperFillManager.fillReport("jasper/rel_mais_locado.jasper", new HashMap(), jrRS);
