...
//
//import br.com.locadora.model.ArmazemModel;
//import br.com.locadora.model.GrupoModel;
...
//                JRResultSetDataSource jrRS = new JRResultSetDataSource(rs);
//                Map parametros = new HashMap();
//                JasperPrint jasperPrint = JasperFillManager.fillReport("./jasper/RetiradaConsumoDestino.jasper", new HashMap(), jrRS);
//                JasperViewer.viewReport(jasperPrint, false);
//            }else{
//                    JOptionPane.showMessageDialog(null, "Registro não encontrado para o filtro informado.");
//                }
