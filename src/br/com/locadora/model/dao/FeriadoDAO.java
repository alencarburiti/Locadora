...
public class FeriadoDAO {
    ...
    public Feriado salvar(Feriado feriado) {
        ...
        String sqlInsert = "INSERT INTO `locadora`.`feriado`(`DESCRICAO`,`DATA_FERIADO`) VALUES (?,?);";
    ...
    public void atualizar(Feriado feriado) {
        ...
        String sqlUpdate = "UPDATE `locadora`.`feriado` SET `DESCRICAO` = ?,`DATA_FERIADO` = ? WHERE `CODIGO_FERIADO` = ?;";
        try {
