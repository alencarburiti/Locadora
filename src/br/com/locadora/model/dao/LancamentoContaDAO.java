...
public class LancamentoContaDAO {
    ...
    public void salvar(LancamentoConta lancamentoConta) {
        ...
        String sqlInsert = "INSERT INTO `locadora`.`lancamento_conta`(`DESCRICAO`,`DOCUMENTO`,`VALOR_A_PAGAR`,\n"
                ...
                + "`FORNECEDOR_CODIGO_FORNECEDOR`, USUARIO_CODIGO_USUARIO, CAIXA_CODIGO_CAIXA) VALUES(?,?,?,?,current_date(),?,?,?, ?, ?);";
    ...
    public void atualizar(LancamentoConta lancamentoConta) {
        ...
        String sqlUpdate = "UPDATE `locadora`.`lancamento_conta` SET `DESCRICAO` = ?,`DOCUMENTO` = ?,\n"
                ...
                + "`DATA_PAGAMENTO` = ?,`FORNECEDOR_CODIGO_FORNECEDOR` = ?, USUARIO_CODIGO_USUARIO = ?, CAIXA_CODIGO_CAIXA = ? WHERE `CODIGO_LANCAMENTO_CONTA` = ?;";
        try {
    ...
    public List<LancamentoConta> getLancamentoContasVencidas(String dataInicial, String dataFinal) {
        List<LancamentoConta> resultado = new ArrayList<LancamentoConta>();
        Connection con = pool.getConnection();
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public List<LancamentoConta> getLancamentoContasAPagar(String dataInicial, String dataFinal) {
        List<LancamentoConta> resultado = new ArrayList<LancamentoConta>();
        Connection con = pool.getConnection();
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public List<LancamentoConta> getLancamentoContasPagos(String dataInicial, String dataFinal) {
        List<LancamentoConta> resultado = new ArrayList<LancamentoConta>();
        Connection con = pool.getConnection();
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    private void setPreparedStatement1(LancamentoConta lancamentoConta, PreparedStatement ps)
        ...
        ps.setInt(8, lancamentoConta.getUsuario().getCodigo_usuario());
        ps.setInt(9, lancamentoConta.getCaixa());
        ps.setInt(10, lancamentoConta.getCodigo_lancamento_contas());
