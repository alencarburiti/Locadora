...
public class Printer {
    ...
    public void comprovanteLocacao(List<ItemLocacao> itens, Dependente dependente) {
        //ESCREVER TXT    
    ...
    public void comprovanteDevolucao(List<ItemLocacao> itens, Dependente dependente) {
        //ESCREVER TXT    
        ...
        try {
            ...
            if (arquivo.exists()) {
                ...
                String data_devolucao = dateFormat.format(itens.get(x).getData_prevista());
